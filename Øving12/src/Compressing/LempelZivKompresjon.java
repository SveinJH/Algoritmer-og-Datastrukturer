...
public class LempelZivKompresjon {
    ...
    private final int MINIMUMS_ORDLENGDE = 5;
        ...
        while (bytesIgjen != 0) {
            ...
            for (int i = 0; i < bytesFromFile.length; i++) { //For hver bokstav i hele filen
                ...
                if (funnetKomprimering) {
                    System.out.println("Komprimering funnet");
    ...
    public static void main(String[] args) {
        LempelZivKompresjon lempelZivNy = new LempelZivKompresjon("Øving12\\src\\Compressing\\problem.txt", "Øving12\\src\\Compressing\\komprimert.lz");
